...
static const vector<string_view> Arcane_Cantrips = {"Arcane Slash", "Ancient Dust", "Bullhorn", "Chill Touch", "Dancing Lights", "Dancing Lights", "Daze", "Detect Magic",
...
static const vector<string_view> Arcane_1st_Level = {"Acidic Burst","Admonishing Ray", "Agitate", "Airburst", "Alarm","Animate Dead", "Animate Rope", "Ant Haul", "Anticpate Peril",
...
static const vector<string_view> Arcane_2nd_Level = {"Acid Arrow", "Animated Assualt", "Ash Cloud", "Befitting Attire", "Blood Duplicate", "Blood Vendetta", "Blur", "bone Spray",
...
static const vector<string_view>  Arcane_3rd_Level = {"Agonizing Despair", "Aqueous Orb", "Bind Undead", "Blazing Dive", "Blindess", "Bottomless Stomach", "Bracing Tendrals",
...
static const vector<string_view>  Arcane_4th_Level = {"Aerial Form", "Aromatic Lure", "Bestial Curse", "Blink", "Call the Blood", "Chromatic Armor", "Chromatic Ray", "Clairvoyance",
...
static const vector<string_view>  Arcane_5th_Level = {"Acid Storm", "Bandits Doom", "Banishment", "Belittling Boast", "Black Tentacles", "Blazing Fissure", "Blinding Foam", "Blink Charge", "Blister",
...
static const vector<string_view>  Arcane_6th_Level = {"Aura of the Unremarkable", "Awaken Entropy", "Baleful Polymorph", "Bound in Death", "Cast into Time", "Catch your Name", "Chain Lightning",
...
static const vector<string_view>  Arcane_7th_Level = {"Blightburn Blast", "Contingency", "Control Sand", "Corrosive Body","Dimensional Lock","Duplicate Foe","Eclipse Burst","Energy Aegis",
...
static const vector<string_view>  Arcane_8th_Level = {"All is One, One is All", "Antimagic Field", "Boil Blood", "Burning Blossoms", "Deluge", "Disappearance", "Discern Location", "Dream Council",
...
static const vector<string_view>  Arcane_9th_Level = {"Astral Labrynth", "Bilocation", "Disjunction", "Divinity Leech","Foresight","Implosion", "Linnorm Sting", "Massacre", "Meteor Swarm",
...
static const vector<string_view>  Arcane_10th_Level = {"Cataclysm", "Fated Confrontation", "Gate", "Indestructibility","Nullify", "Remake","Shadow Army","Time Stop","Wish"};

vector<string_view> Divine_Cantrips = {"Ancient Dust", "Approximate", "Bullhorn", "Chill Touch", "Daze", "Detect Magic", "Disrupt Undead", "Divine Lance", "Forbidding Ward",
    ...
    vector<string_view> Divine_1st_Level = {"Admonishing Ray", "Air Bubble", "Alarm", "Animate Dead", "Bane", "Bless", "Breadcrumbs", "Celestial Accord", "Command",
    ...
    vector<string_view> Divine_2nd_Level = {"Advanced Scurvy","Augury", "Blazing Blade", "Blood Vendetta", "Bone Spray", "Boneshaker", "Bralani Referendum",
    ...
    vector<string_view> Divine_3rd_Level = {"Agonizing Despair", "Behold the Weave", "Bind Undead", "Blindness","Casters Imposition", "Chilling Darkness","Circle of Protection",
    ...
    vector<string_view> Divine_4th_Level = {"Air Walk", "Anathematic Reprisal", "Bloodspray Curse", "Cloak of Light", "Compel True Name", "Dawnflowers Light", "Detect Creator",
    ...
    vector<string_view> Divine_5th_Level = {"Abyssal Plane", "Bandits Doom", "Banishment", "Belittling Boast", "Blackfingers Blades", "Blessing of Defiance", "Blink Charge",
    ...
    vector<string_view> Divine_6th_Level = {"Awaken Entropy", "Blade Barrier", "Blinding Fury", "Bound in Death", "Catch Your Name", "Daemon Form", "Demon Form", "Devil Form",
    ...
    vector<string_view> Divine_7th_Level = {"Angel Form", "Cosmic Form", "Deity's Strike", "Dimensional Lock", "Divine Decree", "Divine Vessel", "Eclipse Burst", "Energy Aegis", "Etheral Jaunt",
    "Finger of Death", "Inexhastible Cynicism", "Moonburst", "Plane Shift", "Regenerate","Return to Essence", "Sunburst","Tempese of Shades"};
    
    vector<string_view> Divine_8th_Level = {"Antimagic Field", "Canticle of Everlasting", "Devour Life", "Discern Location", "Divine Armageddon", "Divine Aura", "Divine Inspiration",
    "Moment of Renewal", "Spiritual Epidemic", "Summon Deific Herald"};
    
    vector<string_view> Divine_9th_Level = {"Astral Labrynth", "Bind Soul", "Crusade", "Foresight", "Massacre", "Overwhelming Presence", "Proliferating Eyes", "Telepathic Demand",
    "Undertaker", "Voracoius Gestalt", "Wall of the Banshee", "Weapon of Judgment"};
    
    vector<string_view> Divine_10th_Level = {"Avatar", "Fated Confrontation", "Gate", "Indestructability", "Miracle", "Nullify", "Remake", "Revival"};
    vector<string_view>  Occult_Cantrips = {"Approximate", "Bullhorn", "Chill Touch", "Dancing Lights", "Daze", "Detect Magic", "Forbidding Ward", "Ghost Sound", "Guidance",
    ...
    vector<string_view>  Occult_1st_Level = {"Agitate", "Alarm", "Animate Dead", "Anticipate Peril", "Aqueous Blast", "Bane", "Biting Words", "Bless", "Breadcrumns", "Celestial Accord",
...
vector<string_view> Occult_2nd_Level = {"Animated Assault", "Animus Mine","Augury","Befitting Attire", "Blistering Invective", "Blood Duplicate", "Blood Vendetta", "Blur",
...
vector<string_view> Occult_3rd_Level = {"Agonizing Despair","Behold the Weave", "Bind Undead", "Blindness", "Bottomless Stomach", "Bracing Tendrils", "Caster's Imposition",
...
vector<string_view> Occult_4th_Level = {"Aromatic Lure", "Bestial Curse", "Blink", "Bloodspray Curse", "Bursting Bloom", "Call the Blood", "Chroma Leech", "Chromatic Armor",
        ...
        vector<string_view> Occult_5th_Level = {"Abberant Form", "Abyssal Plague", "Bandit's Doom", "Banishment", "Belittling Boast", "Black Tentacles", "Blink Eyese", "Blinding Foam",
        ...
        vector<string_view> Occult_6th_Level = {"Aura of the Unremarkable", "Awaken Entropy", "Blanket of Stars", "Blinding Fury","Bound in Death", "Cast into Time",
        ...
        vector<string_view> Occult_7th_Level = {"Blightburn Blast", "Curse of the Spirit Orchestra","Dimensional Lock", "Duplicate Foe", "Energy Aegis", "Ethereal Jaunt", "Force Cage",
        ...
        vector<string_view> Occult_8th_Level = {"Antimagic Field","Canticle of Everlasting Grief","Devour Life","Disaperrance","Discern Location","Dream Council","Falling Sky","Hypnopompic Terrors",
        ...
        vector<string_view> Occult_9th_Level = {"Astral Labyrinth", "Bilocation","Bind Soul", "Divinity Leech", "Foresight","Overwhelming Presence", "Prismatic Shield","Prismatic Sphere",
        ...
        vector<string_view> Occult_10th_Level = {"Alter Reality","Fabricated Truth","Fated Confrontation","Gate","Indestructibility","Nullify","Remake","Shadow Army","Time Stop"};
        vector<string_view> Primal_Cantrips = {"Acid Splash", "Approximate", "Dancing Lights", "Detect Magic", "Disrupt Undead", "Electric Arc", "Gale Blast", "Gouging Claw", "Guidance",
            ...
            vector<string_view> Primal_1st_Level = {"Acidic Burst", "Air Bubble", "Airburst", "Alarm", "Animal Allies", "Ant Haul","Aqueous Blast", "Breadcrumbs", "Briny Bolt",
            ...
            vector<string_view>  Primal_2nd_Level = {"Acid Arrow", "Advanced Scurvy", "Animal Form", "Animal Messenger", "Ash Cloud", "Barkskin", "Blazing Blade", "Bone Spray" "Boneshaker",
            ...
            vector<string_view> Primal_3rd_Level = {"Animal Vision", "Aquesous Orb", "Blazing Dive", "Blindness", "Bottomless Stomach", "Caster's Imposition", "Crashing Wave",
            ...
            vector<string_view> Primal_4th_Level = { "Aerial Form", "Air Walk", "Bestial Curse", "Bloodspray Curse", "Bursting Bloom", "Call the Blood", "Cloak of Light","Compel True Name",
            ...
            vector<string_view> Primal_5th_Level = {"Acid Storm","Banishmnent", "Blackfingers Blades", "Blazing Fissure", "Blessing of Defiance", "Blinding Foam", "Blister", "Chameleon Coat",
            ...
            vector<string_view> Primal_6th_Level = {"Baleful Polymorph", "Blanket of Stars", "Blinding Fury", "Catch Your Name", "Chain Lightning", "Dragon Form", "Elemental Confluence",
            ...
            vector<string_view> Primal_7th_Level = {"Blighburn Blast", "Corrosive Body", "Cosmic  Form", "Eclipse Burst", "Energy Aegis", "Fiery Body", "Finger of Death","Frigid Fury",
            "Mask of Terror", "Moonburst", "Plane Shift", "Regenerate", "Sunburst", "Unfettered Pack", "Volcanic Eruption"};
            
            vector<string_view> Primal_8th_Level = {"All is One, One is All","Boil Blood", "Burning Blossoms", "Clone Companion", "Deluge", "Earthquake", "Horrid Wilting",
             "Moment of Renewal","Monstrocity Form", "Polar Ray", "Punishing Winds", "Whirlwind","Wind Walk"};
            
            vector<string_view> Primal_9th_Level = {"Disjuntion", "Implosion", "Linnorm Sting", "Massacre", "Meteor Swarm", "Nature's Enmity", "One with the Land", "Shapechange",
            "Storm of Vengeance", "Upheaval"};
            
            vector<string_view> Primal_10th_Level ={"Cataclysm", "Dinosaur Fort", "Element Embodied","Fated Confrontation", "Indestructibility", "Nature Incarnate",
